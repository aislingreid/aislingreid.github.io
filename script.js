...
// Define the answer word by selecting a random word from the words list
var answer = WORDS[Math.floor(Math.random() * WORDS.length)];

// Function to allow the Submit function to be triggered by pressing Enter key
...
// Function for pop up with instructions on How to Play button
...
// Close the pop up if user clicks anywhere else on the screen
